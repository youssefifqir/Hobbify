...
@DisplayName("UserProgressDao Integration Tests")
class UserProgressRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("userprogress-test-ref-001");
    ...
    class Save {
        ...
        void persistsEntity() {
            UserProgress saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("userprogress-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<UserProgress> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<UserProgress> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            UserProgress found = dao.findByRef("userprogress-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("userprogress-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            UserProgress found = dao.findByRef("non-existent-ref");
