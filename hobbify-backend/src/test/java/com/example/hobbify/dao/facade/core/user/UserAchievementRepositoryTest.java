...
@DisplayName("UserAchievementDao Integration Tests")
class UserAchievementRepositoryTest {
    ...
    void setUp() {
        ...
        sample.setRef("userachievement-test-ref-001");
    }
    ...
    class Save {
        ...
        void persistsEntity() {
            UserAchievement saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("userachievement-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<UserAchievement> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<UserAchievement> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            UserAchievement found = dao.findByRef("userachievement-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("userachievement-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            UserAchievement found = dao.findByRef("non-existent-ref");
