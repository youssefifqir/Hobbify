...
@DisplayName("FavoriteDao Integration Tests")
class FavoriteRepositoryTest {
    ...
    void setUp() {
        sample = new Favorite();
        sample.setRef("favorite-test-ref-001");
    }
    ...
    class Save {
        ...
        void persistsEntity() {
            Favorite saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("favorite-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<Favorite> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<Favorite> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            Favorite found = dao.findByRef("favorite-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("favorite-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            Favorite found = dao.findByRef("non-existent-ref");
