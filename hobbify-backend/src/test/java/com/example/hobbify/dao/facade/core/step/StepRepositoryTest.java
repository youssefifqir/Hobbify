...
@DisplayName("StepDao Integration Tests")
class StepRepositoryTest {
    ...
    void setUp() {
        sample = new Step();
        sample.setRef("step-test-ref-001");
    ...
    class Save {
        ...
        void persistsEntity() {
            Step saved = dao.save(sample);

            assertThat(saved.getId()).isNotNull().isPositive();
            assertThat(saved.getRef()).isEqualTo("step-test-ref-001");
        }
    ...
    class FindById {
        ...
        void returnsSavedEntity() {
            ...
            Optional<Step> found = dao.findById(saved.getId());
        ...
        void returnsEmpty_whenNotFound() {
            Optional<Step> found = dao.findById(-999L);
    ...
    class FindByRef {
        ...
        void returnsEntityByRef() {
            ...
            Step found = dao.findByRef("step-test-ref-001");

            assertThat(found).isNotNull();
            assertThat(found.getRef()).isEqualTo("step-test-ref-001");
        }

        @Test
        @DisplayName("returns null for unknown ref")
        void returnsNull_whenRefNotFound() {
            Step found = dao.findByRef("non-existent-ref");
