...
class ArchUnitAuthzTest {
    ...
    static void importClasses() {
        imported = new ClassFileImporter()
                ...
                .importPackages("com.example.hobbify.service");
    }
    ...
    void coreEntityServiceMethodsHavePermitAnnotation() {
        ArchRule rule = methods()
                ...
                .and().areDeclaredInClassesThat().resideOutsideOfPackages(
                        "com.example.hobbify.service.impl.security..",
                        "com.example.hobbify.service.impl.email..",
                        "com.example.hobbify.service.impl.storage..")
                .and().arePublic()
                .should().beAnnotatedWith(com.example.hobbify.config.security.authz.Authorize.Permit.class);
